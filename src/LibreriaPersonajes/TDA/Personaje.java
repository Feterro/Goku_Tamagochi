...
public class Personaje implements IPrototype<Personaje> {
    ...
    public Personaje(Personaje personaje) {
        ...
        this.apariencia = personaje.apariencia;
        ...
        this.armas = personaje.armas;
        this.alive = personaje.alive;
        this.posX = personaje.posX;
        this.posY = personaje.posY;
    }
    ...
    public static class BuilderPersonaje implements IBuilder<Personaje> {
        ...
        public BuilderPersonaje addApariencia(String url) {
    ...
    public String toString() {
        return "Personaje:" +
                "Nombre:'" + nombre  + '\n' +
                ", LibreriaPersonajes.Apariencia:" + apariencia + '\n' +
                ", Vida:" + vida + '\n' +
                ", Ataque:" + ataque + '\n' +
                ", Nivel:" + nivel + '\n' +
                ", Campos:" + campos + '\n' +
